...
.content {
  ...
  left: 450px; /* Ajuste conforme a largura da navbar + padding */
  padding: 20px;
...
.search-button {
  background: none; /* Remove a cor de fundo padrão do botão */
  border: none; /* Remove a borda padrão do botão */
  cursor: pointer; /* Define o cursor como pointer para indicar que é clicável */
  padding: 0; /* Remove o padding do botão para ajustar a imagem */
  margin-left: 5px; /* Adiciona um espaçamento entre o input e o botão */
}
