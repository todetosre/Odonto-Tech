  ...
  <div v-if="isVisible" class="modal">
    <div class="modal-content">
      ...
      <form @submit.prevent="salvarMovimentacao">
        ...
        <input type="text" id="valor" v-model="formattedValor" @input="formatValor" required />
  ...
  watch: {
    movimentData: {
      ...
      handler(newData) {
        ...
        // Verifica se tipomoviment está presente e preenche corretamente
        if (!this.moviment.tipomoviment) {
          this.moviment.tipomoviment = 'Entrada';  // Valor padrão caso não exista
        }

        // Garante que o campo datamoviment seja formatado corretamente
